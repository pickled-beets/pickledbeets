...
let add = function (data) {
    ...
    var iCalendarData = [
        ...
        `LOCATION:${location}`,
        `CLASS:${classification}`, // classification can have values: "PUBLIC" / "PRIVATE" / "CONFIDENTIAL" 
        `PRIORITY:9`, // values are 0-9. 0 is "NONE" priority, 1-4 is "HIGH", 5 is "MEDIUM", 6-9 is "LOW"
